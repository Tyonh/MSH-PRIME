...
export default async function LoginPage({
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-zinc-950 p-6 relative overflow-hidden">
      ...
      <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-brand-red/5 rounded-full blur-3xl translate-y-1/2 -translate-x-1/2"></div>
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="bg-zinc-900/50 backdrop-blur-sm p-1 shadow-2xl border border-zinc-800">
          <div className="bg-zinc-900 p-8 border-t-4 border-brand-blue">
            <form action={login} className="space-y-6">
              ...
              <div className="space-y-2">
                <label className="text-[10px] font-[1000] text-zinc-400 uppercase tracking-widest flex items-center gap-2">
                  <UserCircle className="h-3 w-3" /> E-mail de Acesso
                </label>
                <input 
                  name="email"
                  type="email" 
              ...
              <button className="group w-full bg-brand-blue text-white py-4 font-[1000] uppercase italic text-sm hover:bg-white hover:text-brand-blue transition-all transform hover:-translate-y-1 shadow-lg shadow-brand-blue/20 flex items-center justify-center gap-2">
                Entrar no Sistema
            ...
            <div className="mt-8 pt-6 border-t border-zinc-800/50 text-center">
              <Link href="/admin/register" className="text-zinc-500 hover:text-brand-blue text-[10px] font-[1000] uppercase tracking-[0.2em] transition-all">
        ...
        <div className="mt-10 flex flex-col items-center gap-4">
          <p className="text-center text-zinc-700 text-[10px] font-black uppercase tracking-[0.3em] leading-relaxed">
            Acesso Restrito <span className="text-zinc-800 mx-2">|</span> Segurança Criptografada
          </p>
